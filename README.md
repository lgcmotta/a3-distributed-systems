...
It's recommented to install the latest available SDK.
...
These scripts will generate the secrets and the `realm.json` file for the Keycloak container.
    ...
    > **Do not commit your `realm.json`, this file is already ignored but please be sure to not intentionally track or commit this file.**
